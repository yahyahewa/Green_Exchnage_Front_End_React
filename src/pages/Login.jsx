...
function Login() {
  ...
  return (
    <>
      ...
      <div className="px-6 sm:px-12 lg:mx-26 md:px-20 pt-10 grid  md:grid-cols-2 sm:items-start gap-20 min-h-screen">
        <div className=" justify-center hidden sm:flex"><img src={ login} className="w-full h-72 sm:h-96 md:h-[500px] object-contain md:object-cover" /></div>
        <LoginForm/>
