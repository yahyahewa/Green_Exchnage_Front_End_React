  ...
  return (
    <section className="pt- flex items-center flex-col">
      <div className="flex flex-col items-center justify-center md:pt-24 pt-8">
        <h1 className="pb-4 text-3xl sm:text-4xl font-extrabold text-center  from-gray-800">
          One persons Trash is another persons Treasure
        </h1>
        <p className="mt-4 px-4 pb-4 text-md   text-center    font-normal text-md  leading-6 text-lg  text-gray-900 ">
