  ...
  return (
    <section className="pt- flex items-center flex-col">
      <div className="flex flex-col items-center justify-center md:pt-24 pt-8">
        ...
        <h1 className="pb-4 pt-4 px-5 leading-9  text-3xl font-kurdish sm:text-4xl text-to font-extrabold text-center text-transparent bg-clip-text bg-gradient-to-l  from-neutral-800 to-neutral-400">
