...
const Blogs = () => {
  return (
    <>
      <section className="2xl:container overflow-hidden 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-0">
          ...
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4">
              <div className="mx-auto mb-[60px] max-w-[510px] text-center lg:mb-20">
                ...
                <p className=" lg:text-lg text-center font-normal text-md  xl:leading-8 px-4     text-neutral-500">
          ...
          <div className="-mx-4 flex flex-wrap">
            {BlogsCard.map((blog) => {
              ...
              return (
                <div
                  key={id}
                  className="w-full  px-4 mx-0  md:w-1/3  lg:w-1/3 shadow-sm   "
                >
